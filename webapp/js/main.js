 ...
 * This is wrapped in a DOMContentLoaded listener to ensure the DOM is ready
 * before any elements are selected or manipulated.
 */
document.addEventListener('DOMContentLoaded', () => {
    // This IIFE (Immediately Invoked Function Expression) is async to allow for 'await'.
    (async function main() {
        // --- 0. Initialize UI Elements ---
        // This is the first step to ensure all DOM elements are available.
        UI.initElements();
